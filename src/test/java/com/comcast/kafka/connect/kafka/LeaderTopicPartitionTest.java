...
public class LeaderTopicPartitionTest {
  ...
  @Before
  public void setup() {
    objectUnderTest = new LeaderTopicPartition(LEADER_ID, TOPIC, PARTITION);
  }
  ...
  public void testNullTopicName() {
    objectUnderTest = new LeaderTopicPartition(LEADER_ID, null, PARTITION);
  }
  ...
  public void testEquals() {
    LeaderTopicPartition objectUnderTest1 = new LeaderTopicPartition(LEADER_ID, TOPIC, PARTITION);
    LeaderTopicPartition objectUnderTest2 = new LeaderTopicPartition(LEADER_ID, TOPIC, PARTITION);
